...
export default function personalFoodCard ({navigation}){
    ...
    // useEffect(()=>{setCard1(retrieveItem("cardf1")); console.log(card1,"card1")},[])
    // useEffect(()=>{setCard1(retrieveItem("cardf2"));console.log(card2,"card2")},[])
    // useEffect(()=>{setCard1(retrieveItem("cardf3"))},[])
